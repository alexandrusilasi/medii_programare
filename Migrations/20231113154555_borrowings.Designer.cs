...
namespace Silasi_Alexandru_Lab2.Migrations
{
    ...
    [Migration("20231113154555_borrowings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Silasi_Alexandru_Lab2.Models.Borrowing", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Silasi_Alexandru_Lab2.Models.Member", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Silasi_Alexandru_Lab2.Models.Borrowing", b =>
                {
                    b.HasOne("Silasi_Alexandru_Lab2.Models.Book", "Book")
                        .WithOne("Borrowing")
                        .HasForeignKey("Silasi_Alexandru_Lab2.Models.Borrowing", "BookID");

                    b.HasOne("Silasi_Alexandru_Lab2.Models.Member", "Member")
                        .WithMany("Borrowings")
